...
str = input("Ingresar una frase: ")
cap = str.capitalize() #puedo usar str.upper[0]
if str == cap:
  print("La primer letra es mayuscula")
else:
  print("La primer letra es miniscula")
##### **Ejercicio 2**
...
numero = input("Escribir un numero del 1 al 6: ")
if numero >= 1 and <= 6:
  print("La cara opuesta del dado es ") + str(7-numero)
else:
  print("la cara del dado te da incorrecto")
...
numero_del_dia = int(input("Ingresar el numero del dia del 1 a 7: "))
dias_de_semana = {1: "Lunes", 2: "Martes", 3: "Miercoles", 4:"Jueves", 5:"Viernes", 6:"Sabado", 7:"Domingo"}
if numero_del_dia > 7 or numero_del_dia < 1:
  print("El numero ingresado es invalido")
else:
  print(dias_de_semana[numero_del_dia])
...
print(lista_numero)
#print(list.append(lista_numero, numero))
##### **Ejercicio 8**
...
contadores = {}
cadena = input("Escribir cadena de caracteres: ")
for caracter in cadena:
  contadores[caracter] += 1
else:
  contadores[caracter] = 1
  for clave, valor in contandores.items():
    print(clave, valor)
##### **Ejercicio 11**
